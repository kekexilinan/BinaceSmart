...
## 更新摘要
**变更内容**   
- 更新了榜单汇总功能，新增市值/成交额合并列显示
- 引入新的市值过滤机制（MAX_RANKING_MARKET_CAP=80亿美元）
- 改进了8am分档计分系统（≥35%→3分, ≥15%→2分, ≥5%→1分）
- 新增榜单表格结构，支持来源追踪标签
- 增强了服务器端数据丰富化功能，为原始市值和成交量数据提供补充
...
- 内部耦合
  ...
  - **新增**：smart-trend-labels.mjs 提供统一的榜单格式化逻辑
...
- 并发与缓存
  ...
  - pmap 并发控制，限制同时请求数
  - **新增**：市值数据批量缓存，支持CMC和CoinGecko双源回退
- 网络与重试
...
**最新更新**：系统增强了榜单汇总功能，通过市值/成交额合并显示、8am分档计分、来源追踪标签等新特性，提供了更丰富的数据分析维度和更精准的市场洞察能力。
