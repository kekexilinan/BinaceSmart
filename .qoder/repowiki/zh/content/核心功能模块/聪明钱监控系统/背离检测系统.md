...
## 更新摘要
**变更内容**   
- 实现了复杂的大户vs散户背离检测算法，支持可配置阈值和高级统计功能
- 集成系统性反弹机会评分系统，通过多因子加权识别暴跌后的反转机会
- 新增急跌反弹观察高亮区块功能，在推送卡片顶部突出展示潜在反转标的
- 优化背离信号统计与可视化展示，增强决策引擎的连续性跟踪能力
...
**最新更新**：系统现已实现 sophisticated whale vs retail divergence detection（复杂的大户vs散户背离检测），具备可配置的阈值设置，并与反弹机会评分系统深度集成，提供更精准的反转机会识别能力。
...
- [proxy-setup.mjs:1-40](file://proxy-setup.mjs#L1-40)
