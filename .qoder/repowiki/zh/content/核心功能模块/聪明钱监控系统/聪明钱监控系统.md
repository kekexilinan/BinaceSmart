...
- [smart-trend-decision.mjs:291-330](file://smart-trend-decision.mjs#L291-L330)
...
**重大升级**：系统完成了决策引擎的全面重构，引入了完整的行动剧本系统和场景分类机制。新的决策引擎能够根据市场条件和聪明钱行为自动分类7种标准化交易场景，并为每种场景提供详细的操作指导、风险提示和等待条件。pump_risk和distribution警告机制的加入进一步强化了风险管理能力。这些重大升级共同构成了一个更加智能、全面和可靠的聪明钱监控体系，为用户提供更精准的交易决策支持。
