...
- smart-trend-monitor.mjs：聪明钱趋势监控，复用历史数据进行基准对比
...
subgraph "分析与展示"
D["smart-trend-monitor.mjs<br/>趋势监控/基准对比"]
...
- 分析层：趋势监控与持仓健康评估复用历史与实时信号，进行基准对比与决策辅助
...
- [whale-history.mjs:47-64](file://whale-history.mjs#L47-L64)

章节来源
- [whale-history.mjs:24-45](file://whale-history.mjs#L24-L45)
- [whale-history.mjs:47-90](file://whale-history.mjs#L47-L90)
- [whale-history.mjs:92-119](file://whale-history.mjs#L92-L119)
- [whale-history.mjs:121-141](file://whale-history.mjs#L121-L141)
...
Score --> Persist["queueSaveState()"]
```

图表来源
- [smart-trend-monitor.mjs:139-170](file://smart-trend-monitor.mjs#L139-L170)
- [smart-trend-monitor.mjs:259-277](file://smart-trend-monitor.mjs#L259-L277)
- [smart-trend-monitor.mjs:293-318](file://smart-trend-monitor.mjs#L293-L318)
...
- 模块耦合
  ...
  - smart-trend-monitor.mjs 依赖 whale-history.mjs 的历史与批量查询
...
## 结论
鲸鱼历史追踪子系统以 Smart Signal 为核心数据源，通过“采集-存储-查询-分析”的清晰分层，实现了稳定可靠的大户行为历史记录与可视化支撑。其去重合并、容量控制、异步落盘与限流熔断等机制，保证了在高并发与不稳定网络环境下的可用性。配合趋势监控与持仓健康评估，可为市场影响分析与交易决策提供有力依据。
