...
## 简介
本系统为“暴跌风险预警”提供多维度风险评估、高危币种筛选、预警触发与推送能力，并结合聪明钱（Smart Money）趋势监控与持仓健康检查，形成从“市场扫描—风险评分—决策建议—推送触达”的闭环。文档重点覆盖：
...
subgraph "风险与策略"
D["scan-dump-risk.mjs<br/>暴跌风险评分"]
...
## 架构总览
系统以 server.mjs 为中枢，集成多个扫描与评估模块，通过环境变量驱动开关与阈值，统一通过飞书 Webhook 推送结果。
...
## 结论
本系统通过多维风险因子量化暴跌风险，结合聪明钱趋势与持仓健康，形成“发现—评估—决策—推送”的完整链路。通过并发优化、缓存与限流策略，兼顾实时性与稳定性。建议在生产环境合理设置市值过滤、推送间隔与阈值，以降低误报并提升可操作性。
...
- 暴跌预警推送
  - 标题：暴跌预警 · N高危 M警告
  - 内容：高危与警告分组列表，含24h涨跌、风险分、主要风险标签
- 暴涨+聪明钱加仓推送
  - 标题：暴涨+聪明钱加仓提醒
